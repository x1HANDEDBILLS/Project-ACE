...
class NeonBar : public QWidget
{
   public:
    ...
    void refresh()
    {
        // Port 2 offset is 50. This pulls processed data from the 200-slot buffer.
...
void setup_input_read_page2_content(QWidget* p)
{
    auto* main_layout = new QVBoxLayout(p);
    main_layout->setContentsMargins(15, 10, 15, 10);

    QLabel* status = new QLabel("PORT 2 STATUS");
    ...
    // PORT 2 AXES: Slots 50-57
    v_box->addWidget(createHeader("PORT 2 ANALOG (50-57)", theme));
    for (int i = 0; i < 8; i++) {
    ...
    // PORT 2 MOTION: Slots 80-88
    v_box->addWidget(createHeader("PORT 2 MOTION (80-88)", theme));
    ...
    // PORT 2 BUTTONS: Slots 58-79
    v_box->addWidget(createHeader("PORT 2 BUTTONS (58-79)", theme));
