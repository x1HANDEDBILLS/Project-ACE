// Location: src/GUI/vehicles/plane/rc_map_plane_page2.cpp
    ...
    for (int i = 0; i < 6; i++) {
        ...
        connect(mixers[i].target_btn, &QPushButton::clicked, [this, i]() {
            ...
            for (int j = 0; j < 16; j++) {
                ...
                b->setStyleSheet("background: #2a2a35; color: #eee; border: 1px solid #444; font-weight: bold; "
                                 "font-size: 16px;");
            ...
            off->setStyleSheet("background: #442222; color: white; font-weight: bold; border: 1px solid #ff4444;");
        ...
        QString nStyle = QString("QCheckBox { color: #bbb; font-weight: bold; } QCheckBox::indicator { width: 45px; "
        ...
        QString pStyle = QString("QCheckBox { color: #bbb; font-weight: bold; } QCheckBox::indicator { width: 45px; "
                                 "height: 45px; border: 1px solid #555; background: #050505; border-radius: 5px; } "
