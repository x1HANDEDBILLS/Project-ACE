// LOCATION: /home/user/ACE/src/GUI/vehicles/drone/rc_tune_drone_panel.cpp
...
#include "theme.h"
#include "vehicles/drone/rc_tune_drone_page1.h"
#include "vehicles/drone/rc_tune_drone_page2.h"
#include "vehicles/drone/rc_tune_drone_page3.h"
#include "vehicles/drone/rc_tune_drone_page4.h"
#include "vehicles/drone/rc_tune_drone_page5.h"
...
RCTuneDronePanel::RCTuneDronePanel(QWidget *parent) : QFrame(parent)
{
    ...
    for (int i = 0; i < 5; ++i) {
        ...
        if (i == 0)
            setup_rc_tune_drone_page1_content(p);
        else if (i == 1)
