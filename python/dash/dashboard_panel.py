...
class DashboardPanel(QWidget):
    def __init__(self, parent=None):
        ...
        # 1. MAIN HUD GEAR (74x74 Original)
        ...
        # 2. MAIN SHIELD (Transparent input snatcher)
        ...
        # 4. POPOUT DEDICATED SHIELD (Transparent - No Dimming)
        ...
        # 6. SIDEBAR (Initial State: Right side)
    ...
    def toggle_theme_panel(self):
        ...
        if not self.theme_open:
            ...
            target_x = (w - self.theme_panel.width()) // 2
            target_y = (h - self.theme_panel.height()) // 2
