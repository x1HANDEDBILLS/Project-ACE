// LOCATION: /home/user/ACE/include/rc_type/rc_type_panel.h
...
class RCTypePanel : public QFrame
{
   ...
   private:
    ...
    QStringList page_titles = {"AIRCRAFT SELECT", "WING CONFIG", "TAIL TYPE", "MOTOR SETUP",
                               "OUTPUT MAPPING"};
};
#endif